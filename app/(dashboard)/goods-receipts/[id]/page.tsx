    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        ...
        <table className="w-full text-sm">
          ...
          <tfoot>
            <tr>
              <td colSpan={4} className="pt-3 text-right font-semibold">ยอดรวม</td>
              <td className="pt-3 text-right font-bold text-green-700 text-base">฿{formatCurrency(gr.po.totalAmount)}</td>
            </tr>
          </tfoot>
        </table>
      </div>
